...
function svgIcon(opts) {
  ...
  /** Rounded-square tile; motif smaller for adaptive safe zone when maskable. */
  var rOuter = maskable ? 88 : 108;
  var rInner = rOuter - 10;
  var rInnerHi = rOuter - 16;
  var scale = maskable ? 0.78 : 1;
  var g = [
    ...
    '  <path d="M160 268h192" stroke="url(#silver)" stroke-width="34" stroke-linecap="round" fill="none"/>',
    '  <path d="M124 226h56v82h-56c-22 0-40-18-40-41s18-41 40-41z" fill="url(#silver)" stroke="rgba(212,216,224,0.35)" stroke-width="2"/>',
    '  <path d="M332 226h56v82h-56c22 0 40-18 40-41s-18-41-40-41z" fill="url(#silver)" stroke="rgba(212,216,224,0.35)" stroke-width="2"/>',
    "</g>",
    "</svg>",
  ].join("");
